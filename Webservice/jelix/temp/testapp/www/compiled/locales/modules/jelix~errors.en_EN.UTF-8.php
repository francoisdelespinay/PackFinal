<?php $_loaded= array (
  ...
  'xml.remote.feed.error' => '(60) Error while reading the remote feed',
  'xml.loading.document.error' => '(61) Error(s) while loading the XML document : %s',
  ...
  'tcpdf.fonts_missing' => '(600)The TCPDF font directory does not exist. Check you downloaded the additional fonts from the Jelix website',
) ?>